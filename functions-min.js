...
!function(t, e) {
    ...
    if (!r.TweenLite) {
        var n, s, o, a, l, h = function(t) {
            var e, i = t.split("."), n = r;
            for (e = 0; e < i.length; e++)
                n[i[e]] = n = n[i[e]] || {};
            return n
        }, u = h("com.greensock"), f = 1e-10, c = function(t) {
            var e, i = [], r = t.length;
            ...
            this.check = function(u) {
                for (var f, c, p, d, g, v = s.length, y = v; --v > -1; )
                    (f = _[s[v]] || new m(s[v],[])).gsClass ? (l[v] = f.gsClass,
                    y--) : u && f.sc.push(this);
                if (0 === y && o) {
                    if (c = ("com.greensock." + n).split("."),
                    p = c.pop(),
                    d = h(c.join("."))[p] = this.gsClass = o.apply(o, l),
                    a)
                        if (r[p] = i[p] = d,
        ...
        var y = [0, 0, 1, 1]
          ...
          , T = x.register = function(t, e, i, r) {
            for (var n, s, o, a, l = e.split(","), h = l.length, f = (i || "easeIn,easeOut,easeInOut").split(","); --h > -1; )
                for (s = l[h],
                n = r ? v("easing." + s, null, !0) : u.easing[s] || {},
                o = f.length; --o > -1; )
                    a = f[o],
        ...
        s = n.length; --s > -1; )
            o = n[s] + ",Power" + s,
            T(new x(null,null,1,s), o, "easeOut", !0),
            T(new x(null,null,2,s), o, "easeIn" + (0 === s ? ",easeNone" : "")),
            T(new x(null,null,3,s), o, "easeInOut");
        ...
        o.addEventListener = function(t, e, i, r, n) {
            n = n || 0;
            var s, o, h = this._listeners[t], u = 0;
            for (this !== a || l || a.wake(),
            null == h && (this._listeners[t] = h = []),
            o = h.length; --o > -1; )
                s = h[o],
                s.c === e && s.s === i ? h.splice(o, 1) : 0 === u && s.pr < n && (u = o + 1);
            h.splice(u, 0, {
                c: e,
                s: i,
                up: r,
        ...
        s = n.length; --s > -1 && !P; )
            P = t[n[s] + "RequestAnimationFrame"],
            S = t[n[s] + "CancelAnimationFrame"] || t[n[s] + "CancelRequestAnimationFrame"];
        v("Ticker", function(t, e) {
            var i, r, n, s, o, h = this, u = O(), c = e !== !1 && P ? "auto" : !1, d = 500, _ = 33, m = "tick", g = function(t) {
                var e, a, l = O() - k;
                l > d && (u += l - _),
                k += l,
                h.time = (k - u) / 1e3,
        ...
        o.totalTime = function(t, e, i) {
            ...
            if (this._timeline) {
                ...
                (this._totalTime !== t || 0 === this._duration) && (z.length && Z(),
                this.render(t, e, !1),
                z.length && Z())
            }
            return this
        ...
        o.paused = function(t) {
            ...
            return t != this._paused && r && (l || t || a.wake(),
            e = r.rawTime(),
            i = e - this._pauseTime,
        ...
        var M = v("TweenLite", function(e, i, r) {
            ...
            (a || e instanceof Array || e.push && d(e)) && "number" != typeof e[0])
                ...
                n = 0; n < o.length; n++)
                    ...
                    this._targets = o = o.concat(c(s))) : (this._siblings[n] = H(s, this, !1),
                    1 === l && this._siblings[n].length > 1 && $(s, this, null, 1, this._siblings[n])) : (s = o[n--] = M.selector(s),
                    "string" == typeof s && o.splice(n + 1, 1)) : o.splice(n--, 1);
            else
                this._propLookup = {},
                this._siblings = H(e, this, !1),
          ...
          , L = function(t, e) {
            var i, r = {};
            for (i in t)
                V[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!I[i] || I[i] && I[i]._autoCSS) || (r[i] = t[i],
                delete t[i]);
            t.css = r
        };
        o = M.prototype = new C,
        ...
        var z = []
          ...
          , X = function(t) {
            for (var e, i = this._firstPT, r = 1e-6; i; )
                ...
                i.m ? e = i.m(e, this._target || i.t) : r > e && e > -r && (e = 0),
                i.f ? i.fp ? i.t[i.p](i.fp, e) : i.t[i.p](e) : i.t[i.p] = e,
                i = i._next
        }
          , N = function(t, e, i, r) {
            var n, s, o, a, l, h, u, f = [t, e], c = 0, p = "", d = 0;
            for (f.start = t,
            i && (i(f),
            t = f[0],
            e = f[1]),
            ...
            a = 0; l > a; a++)
                ...
                u === n[a] || n.length <= a ? p += u : (p && (f.push(p),
                p = ""),
                o = parseFloat(n[a]),
                f.push(o),
                f._firstPT = {
          ...
          , Y = function(t, e, i, r, n, s, o, a, l) {
            ...
            var h, u, f = "get" === i ? t[e] : i, c = typeof t[e], p = "string" == typeof r && "=" === r.charAt(1), d = {
                t: t,
                p: e,
                s: f,
                f: "function" === c,
            ...
            d.s = f = o ? t[u](o) : t[u]()),
            "string" == typeof f && (o || isNaN(f)) ? (d.fp = o,
            h = N(f, r, a || M.defaultStringFilter, d),
            d = {
                t: h,
                p: "setRatio",
                s: 0,
        ...
        C._updateRoot = M.render = function() {
            ...
            a.frame >= Q) {
                ...
                if (i = G._first,
                (!i || i._paused) && M.autoSleep && !W._first && 1 === a._listeners.tick.length) {
                    for (; i && i._paused; )
                        i = i._next;
                    i || a.sleep()
                }
        ...
        var H = function(t, e, i) {
          ...
          , $ = function(t, e, i, r, n) {
            ...
            var h, u = e._startTime + f, c = [], p = 0, d = 0 === e._duration;
            for (s = n.length; --s > -1; )
                (a = n[s]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (h = h || J(e, 0, d),
                0 === J(a, h, d) && (c[p++] = a)) : a._startTime <= u && a._startTime + a.totalDuration() / a._timeScale > u && ((d || !a._initted) && u - a._startTime <= 2e-10 || (c[p++] = a)));
            for (s = p; --s > -1; )
                if (a = c[s],
          ...
          , J = function(t, e, i) {
            ...
            return s /= n,
            s > e ? s - e : i && s === e || !t._initted && 2 * f > s - e ? f : (s += t.totalDuration() / t._timeScale / n) > e + f ? 0 : s - e - f
        };
        o._init = function() {
            var t, e, i, r, n, s, o = this.vars, a = this._overwrittenProps, l = this._duration, h = !!o.immediateRender, u = o.ease;
            if (o.startAt) {
            ...
            if (this._ease = u = u ? u instanceof x ? u : "function" == typeof u ? new x(u,o.easeParams) : w[u] || M.defaultEase : M.defaultEase,
        ...
        o._initProps = function(e, i, r, n, s) {
            ...
            if (null == e)
                return !1;
            D[e._gsTweenID] && Z(),
            this.vars.css || e.style && e !== t && e.nodeType && I.css && this.vars.autoCSS !== !1 && L(this.vars, e);
            for (o in this.vars)
                if (f = this.vars[o],
                V[o])
                    f && (f instanceof Array || f.push && d(f)) && -1 !== f.join("").indexOf("{self}") && (this.vars[o] = f = this._swapSelfInParams(f, this));
                    ...
                    i[o] = Y.call(this, e, o, "get", f, o, 0, null, this.vars.stringFilter, s);
            return n && this._kill(n, e) ? this._initProps(e, i, r, n, s) : this._overwrite > 1 && this._firstPT && r.length > 1 && $(e, this, i, this._overwrite, r) ? (this._kill(i, e),
            this._initProps(e, i, r, n, s)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (D[e._gsTweenID] = !0),
            l)
        }
        ,
        o.render = function(t, e, i) {
            ...
            if (t >= l - 1e-7)
                ...
                (0 > h || 0 >= t && t >= -1e-7 || h === f && "isPause" !== this.data) && h !== t && (i = !0,
                h > f && (n = "onReverseComplete")),
        ...
        o._kill = function(t, e, i) {
            ...
            var r, n, s, o, a, l, h, u, f, c = i && this._time && i._startTime === this._startTime && this._timeline === i._timeline;
            if ((d(e) || F(e)) && "number" != typeof e[0])
                ...
                if (a) {
                    if (h = t || a,
                    u = t !== n && "all" !== n && t !== a && ("object" != typeof t || !t._tempKill),
        ...
        o._enabled = function(t, e) {
            ...
            t && this._gc) {
                ...
                if (r)
                    for (i = r.length; --i > -1; )
                        this._siblings[i] = H(r[i], this, !0);
                else
                    this._siblings = H(this.target, this, !0)
            }
        ...
        tt.activate = function(t) {
            for (var e = t.length; --e > -1; )
                t[e].API === tt.API && (I[(new t[e])._propName] = t[e]);
            return !0
        }
        ,
        g.plugin = function(t) {
        ...
        n = t._gsQueue) {
            for (s = 0; s < n.length; s++)
                n[s]();
            for (o in _)
                _[o].func || t.console.log("GSAP encountered missing dependency: " + o)
        }
        l = !1
    }
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
        ...
        m.staggerTo = function(t, e, n, s, o, l, h, u) {
            ...
            d = 0; d < t.length; d++)
                f = c(n),
                f.startAt && (f.startAt = c(f.startAt),
        ...
        m.add = function(n, s, o, a) {
            ...
            (this._gc || this._time === this._duration) && !this._paused && this._duration < this.duration())
                for (p = this,
                d = p.rawTime() > n._startTime; p._timeline; )
        ...
        m.render = function(t, e, i) {
            this._gc && this._enabled(!0, !1);
            var r, s, o, a, l, f, c, p = this._dirty ? this.totalDuration() : this._totalDuration, d = this._time, _ = this._startTime, m = this._timeScale, g = this._paused;
            if (t >= p - 1e-7)
                ...
                (0 !== d || 0 === this._duration && this._rawPrevTime !== n && (this._rawPrevTime > 0 || 0 > t && this._rawPrevTime >= 0)) && (a = "onReverseComplete",
                s = this._reversed),
                0 > t)
                    this._active = !1,
            ...
            if (this._time !== d && this._first || i || l || f) {
                ...
                c >= d)
                    ...
                    c === this._time && (!this._paused || g)); )
                        (r._active || r._startTime <= c && !r._paused && !r._gc) && (f === r && this.pause(),
                ...
                a && (this._gc || (_ === this._startTime || m !== this._timeScale) && (0 === this._time || p >= this.totalDuration()) && (s && (h.length && u(),
        ...
        m.getChildren = function(t, e, r, n) {
            ...
            for (var s = [], o = this._first, a = 0; o; )
                o._startTime < n || (o instanceof i ? e !== !1 && (s[a++] = o) : (r !== !1 && (s[a++] = o),
                t !== !1 && (s = s.concat(o.getChildren(!0, e, r)),
                a = s.length))),
                o = o._next;
            return s
        }
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
        ...
        var u, f, c, p, d, _, m, g, v = /(?:\-|\.|\b)(\d|\.|e\-)+/g, y = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, x = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, w = /(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g, T = /(?:\d|\-|\+|=|#|\.)*/g, b = /opacity *= *([^)]*)/i, P = /opacity:([^;]*)/i, S = /alpha\(opacity *=.+?\)/i, O = /^(rgb|hsl)/, k = /([A-Z])/g, C = /-([a-z])/gi, A = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, R = function(t, e) {
            return e.toUpperCase()
        }, M = /(?:Left|Right|Width)/i, F = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, L = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, z = /,(?=[^\)]*(?:\(|$))/gi, D = /[\s,\(]/i, E = Math.PI / 180, X = 180 / Math.PI, N = {}, Y = document, j = function(t) {
            return Y.createElementNS ? Y.createElementNS("http://www.w3.org/1999/xhtml", t) : Y.createElement(t)
        }, I = j("div"), B = j("img"), q = o._internals = {
            _specialProps: l
        }, V = navigator.userAgent, U = function() {
            var t = V.indexOf("Android")
              , e = j("a");
            return c = -1 !== V.indexOf("Safari") && -1 === V.indexOf("Chrome") && (-1 === t || Number(V.substr(t + 8, 1)) > 3),
            ...
            r = 5; --r > -1 && void 0 === n[i[r] + t]; )
                ;
            return r >= 0 ? (Z = 3 === r ? "ms" : i[r],
            Q = "-" + Z.toLowerCase() + "-",
            Z + t) : null
        }, K = Y.defaultView ? Y.defaultView.getComputedStyle : function() {}
        , $ = o.getStyle = function(t, e, i, r, n) {
            var s;
            return U || "opacity" !== e ? (!r && t.style[e] ? s = t.style[e] : (i = i || K(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(k, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]),
            null == n || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : n) : W(t)
        }
        , J = q.convertToPixels = function(t, i, r, n, s) {
            ...
            if ("auto" === n || !r)
                return 0;
            var a, l, h, u = M.test(i), f = t, c = I.style, p = 0 > r, d = 1 === r;
            if (p && (r = -r),
            d && (r *= 100),
            "%" === n && -1 !== i.indexOf("border"))
                a = r / 100 * (u ? t.clientWidth : t.clientHeight);
            else {
                if (c.cssText = "border:0 solid red;position:" + $(t, "position") + ";line-height:0;",
                "%" !== n && f.appendChild && "v" !== n.charAt(0) && "rem" !== n)
                    c[u ? "borderLeftWidth" : "borderTopWidth"] = r + n;
                else {
                    if (f = t.parentNode || Y.body,
                    l = f._gsCache,
                    h = e.ticker.frame,
                    l && u && l.time === h)
                ...
                f.removeChild(I),
                u && "%" === n && o.cacheWidths !== !1 && (l = f._gsCache = f._gsCache || {},
                l.time = h,
                l.width = a / r * 100),
                0 !== a || s || (a = J(t, i, r, n, !0))
            }
        ...
        , et = function(t, e) {
            ...
            if (e = e || K(t, null))
                if (i = e.length)
                    for (; --i > -1; )
                        n = e[i],
                        (-1 === n.indexOf("-transform") || Ct === n) && (s[n.replace(C, R)] = e.getPropertyValue(n));
                else
                    for (i in e)
                        (-1 === i.indexOf("Transform") || kt === i) && (s[i] = e[i]);
            else if (e = t.currentStyle || t.style)
                for (i in e)
                    "string" == typeof i && void 0 === s[i] && (s[i.replace(C, R)] = e[i]);
            return U || (s.opacity = W(t)),
            r = It(t, e, !1),
            ...
            for (o in i)
                "cssText" !== o && "length" !== o && isNaN(o) && (e[o] !== (s = i[o]) || n && n[o]) && -1 === o.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[o] = "auto" !== s || "left" !== o && "top" !== o ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof e[o] || "" === e[o].replace(w, "") ? s : 0 : tt(t, o),
            ...
            width: ["Left", "Right"],
            height: ["Top", "Bottom"]
        }, nt = ["marginLeft", "marginRight", "marginTop", "marginBottom"], st = function(t, e, i) {
            ...
            for (i = i || K(t, null); --s > -1; )
                r -= parseFloat($(t, "padding" + n[s], i, !0)) || 0,
                r -= parseFloat($(t, "border" + n[s] + "Width", i, !0)) || 0;
            return r
        }, ot = function(t, e) {
            ...
            s.length && (r && (r[i] = e + o),
            -1 !== t.indexOf("short") && (o %= n,
            o !== o % (n / 2) && (o = 0 > o ? o + n : o - n)),
            ...
            h === u ? o = a = 0 : (f = h - u,
            a = l > .5 ? f / (2 - h - u) : f / (h + u),
            o = h === r ? (n - s) / f + (s > n ? 6 : 0) : h === n ? (s - r) / f + 2 : (r - n) / f + 4,
            o *= 60),
            i[0] = o + .5 | 0,
            i[1] = 100 * a + .5 | 0,
            i[2] = 100 * l + .5 | 0),
        ...
        var _t = function(t, e, i, r) {
            if (null == t)
                ...
                ;
            var n, s = e ? (t.match(dt) || [""])[0] : "", o = t.split(s).join("").match(x) || [], a = t.substr(0, t.indexOf(o[0])), l = ")" === t.charAt(t.length - 1) ? ")" : "", h = -1 !== t.indexOf(" ") ? " " : ",", u = o.length, f = u > 0 ? o[0].replace(v, "") : "";
            return u ? n = e ? function(t) {
                var e, c, p, d;
                if ("number" == typeof t)
                    t += f;
                else if (r && z.test(t)) {
                    for (d = t.replace(z, "|").split("|"),
                    p = 0; p < d.length; p++)
                        d[p] = n(d[p]);
                    return d.join(",")
                }
          ...
          , gt = (q._setPluginRatio = function(t) {
            ...
            for (var e, i, r, n, s, o = this.data, a = o.proxy, l = o.firstMPT, h = 1e-6; l; )
                e = a[l.v],
        ...
        function(t, e, i, r, n) {
          ...
          , vt = (q._parseToProxy = function(t, e, i, r, n, s) {
            var o, a, l, h, u, f = r, c = {}, p = {}, d = i._transform, _ = N;
        ...
        q.CSSPropTween = function(t, e, r, n, o, a, l, h, u, f, c) {
          ...
          , xt = o.parseComplex = function(t, e, i, r, n, s, a, l, h, f) {
            ...
            a = new vt(t,e,0,0,a,f ? 2 : 1,null,!1,l,i,r),
            r += "",
            n && dt.test(r + i) && (r = [i, r],
            o.colorStringFilter(r),
            i = r[0],
            r = r[1]);
            var c, p, d, _, x, w, T, b, P, S, O, k, C, A = i.split(", ").join(",").split(" "), R = r.split(", ").join(",").split(" "), M = A.length, F = u !== !1;
            for ((-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) && (A = A.join(" ").replace(z, ", ").split(" "),
            R = R.join(" ").replace(z, ", ").split(" "),
            M = A.length),
            M !== R.length && (A = (s || "").split(" "),
            M = A.length),
            a.plugin = h,
            a.setRatio = f,
            dt.lastIndex = 0,
            c = 0; M > c; c++)
                ...
                b = parseFloat(_),
                b || 0 === b)
                    a.appendXtra("", b, at(x, b), x.replace(y, ""), F && -1 !== x.indexOf("px"), !0);
                else if (n && dt.test(_))
                    k = x.indexOf(")") + 1,
                    k = ")" + (k ? x.substr(k) : ""),
                    C = -1 !== x.indexOf("hsl") && U,
                    ...
                    P && !U && 0 === x[3] ? (a["xs" + a.l] += a.l ? " transparent" : "transparent",
                    a.e = a.e.split(R[c]).join("transparent")) : (U || (P = !1),
                    C ? a.appendXtra(P ? "hsla(" : "hsl(", _[0], at(x[0], _[0]), ",", !1, !0).appendXtra("", _[1], at(x[1], _[1]), "%,", !1).appendXtra("", _[2], at(x[2], _[2]), P ? "%," : "%" + k, !1) : a.appendXtra(P ? "rgba(" : "rgb(", _[0], x[0] - _[0], ",", !0, !0).appendXtra("", _[1], x[1] - _[1], ",", !0).appendXtra("", _[2], x[2] - _[2], P ? "," : k, !0),
                    P && (_ = _.length < 4 ? 1 : _[3],
                    a.appendXtra("", _, (x.length < 4 ? 1 : x[3]) - _, k, !1))),
                    dt.lastIndex = 0;
                else if (w = _.match(v)) {
                    if (T = x.match(y),
                    !T || T.length !== w.length)
                    ...
                    p = 0; p < w.length; p++)
                        O = w[p],
                        S = _.indexOf(O, d),
                        a.appendXtra(_.substr(d, S - d), Number(O), at(T[p], O), "", F && "px" === _.substr(S + O.length, 2), 0 === p),
                        d = S + O.length;
                    a["xs" + a.l] += _.substr(d)
                } else
            ...
            if (!l[t]) {
                ...
                bt(t, {
                    parser: function(t, i, r, n, s, o, h) {
                        ...
                        l[r].parse(t, i, r, n, s, o, h)) : (G("Error: " + e + " js file not loaded."),
                        s)
                    }
                })
            }
        ...
        h.parseComplex = function(t, e, i, r, n, s) {
            var o, a, l, h, u, f, c = this.keyword;
            if (this.multi && (z.test(i) || z.test(e) ? (a = e.replace(z, "|").split("|"),
            l = i.replace(z, "|").split("|")) : c && (a = [e],
            l = [i])),
            l) {
                ...
                o = 0; h > o; o++)
                    ...
                    c && (u = e.indexOf(c),
                    f = i.indexOf(c),
                    u !== f && (-1 === f ? a[o] = a[o].split(c).join("") : -1 === u && (a[o] += " " + c)));
                e = a.join(", "),
                i = l.join(", ")
            }
        ...
        var St, Ot = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","), kt = H("transform"), Ct = Q + "transform", At = H("transformOrigin"), Rt = null !== H("perspective"), Mt = q.Transform = function() {
            this.perspective = parseFloat(o.defaultTransformPerspective) || 0,
            this.force3D = o.defaultForce3D !== !1 && Rt ? o.defaultForce3D || "auto" : !1
        }
        , Ft = window.SVGElement, Lt = function(t, e, i) {
            var r, n = Y.createElementNS("http://www.w3.org/2000/svg", t), s = /([a-z])([A-Z])/g;
            for (r in i)
                n.setAttributeNS(null, r.replace(s, "$1-$2").toLowerCase(), i[r]);
            return e.appendChild(n),
            n
        }, zt = Y.documentElement, Dt = function() {
            var t, e, i, r = _ || /Android/i.test(V) && !window.chrome;
            return Y.createElementNS && !r && (t = Lt("svg", zt),
            e = Lt("rect", t, {
                width: 100,
                height: 50,
                x: 100
            ...
            var a, l, h, u, f, c, p, d, _, m, g, v, y, x, w = t._gsTransform, T = jt(t, !0);
            w && (y = w.xOrigin,
            x = w.yOrigin),
            ...
            i.yOffset = w.yOffset,
            w = i),
            n || n !== !1 && o.defaultSmoothOrigin !== !1 ? (l = u - y,
            h = f - x,
            ...
            var i, r, n, s, o, a, l = t._gsTransform || new Mt, h = 1e5, u = t.style;
            if (kt ? r = $(t, Ct, null, !0) : t.currentStyle && (r = t.currentStyle.filter.match(F),
            ...
            i && kt && ((a = "none" === K(t).display) || !t.parentNode) && (a && (s = u.display,
            u.display = "block"),
            t.parentNode || (o = 1,
            zt.appendChild(t)),
            r = $(t, Ct, null, !0),
            ...
            o && zt.removeChild(t)),
            (l.svg || t.getBBox && Nt(t)) && (i && -1 !== (u[kt] + "").indexOf("matrix") && (r = u[kt],
            i = 0),
            ...
            wt = n.length; --wt > -1; )
                s = Number(n[wt]),
                n[wt] = (o = s - (s |= 0)) ? (o * h + (0 > o ? -.5 : .5) | 0) / h + s : s;
            return e && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n
        }, It = q.getTransform = function(t, i, r, n) {
            if (t._gsTransform && r && !n)
                return t._gsTransform;
            var s, a, l, h, u, f, c = r ? t._gsTransform || new Mt : new Mt, p = c.scaleX < 0, d = 2e-5, _ = 1e5, m = Rt ? parseFloat($(t, At, i, !1, "0 0 0").split(" ")[2]) || c.zOrigin || 0 : 0, g = parseFloat(o.defaultTransformPerspective) || 0;
            if (c.svg = !(!t.getBBox || !Nt(t)),
            c.svg && (Et(t, $(t, At, i, !1, "50% 50%") + "", c, t.getAttribute("data-svg-origin")),
            St = o.useSVGTransformAttr || Dt),
            s = jt(t),
            s !== Yt) {
                if (16 === s.length) {
                    var v, y, x, w, T, b = s[0], P = s[1], S = s[2], O = s[3], k = s[4], C = s[5], A = s[6], R = s[7], M = s[8], F = s[9], L = s[10], z = s[12], D = s[13], E = s[14], N = s[11], Y = Math.atan2(A, L);
                    c.zOrigin && (E = -c.zOrigin,
                    z = M * E - s[12],
                    D = F * E - s[13],
                    E = L * E + c.zOrigin - s[14]),
                    c.rotationX = Y * X,
                    Y && (w = Math.cos(-Y),
                    T = Math.sin(-Y),
                    v = k * w + M * T,
                    ...
                    c.scaleX = (Math.sqrt(b * b + P * P) * _ + .5 | 0) / _,
                    c.scaleY = (Math.sqrt(C * C + F * F) * _ + .5 | 0) / _,
                    c.scaleZ = (Math.sqrt(A * A + L * L) * _ + .5 | 0) / _,
                    c.rotationX || c.rotationY ? c.skewX = 0 : (c.skewX = k || C ? Math.atan2(k, C) * X + c.rotation : c.skewX || 0,
                    Math.abs(c.skewX) > 90 && Math.abs(c.skewX) < 270 && (p ? (c.scaleX *= -1,
                    ...
                    Math.abs(f) > 90 && Math.abs(f) < 270 && (p ? (l *= -1,
                    f += 0 >= u ? 180 : -180,
                    u += 0 >= u ? 180 : -180) : (h *= -1,
                    f += 0 >= f ? 180 : -180)),
                    c.scaleX = l,
                    ...
                    c.rotation = u,
                    c.skewX = f,
                    Rt && (c.rotationX = c.rotationY = c.z = 0,
                    c.perspective = g,
                    c.scaleZ = 1),
                    c.svg && (c.x -= c.xOrigin - (c.xOrigin * I + c.yOrigin * q),
                    c.y -= c.yOrigin - (c.xOrigin * B + c.yOrigin * V))
                }
                c.zOrigin = m;
                for (a in c)
                    c[a] < d && c[a] > -d && (c[a] = 0)
            ...
            c.svg && (St && t.style[kt] ? e.delayedCall(.001, function() {
                Vt(t.style, kt)
        ...
        , $t = function(t) {
            var e, i, r = this.data, n = -r.rotation * E, s = n + r.skewX * E, o = 1e5, a = (Math.cos(n) * r.scaleX * o | 0) / o, l = (Math.sin(n) * r.scaleX * o | 0) / o, h = (Math.sin(s) * -r.scaleY * o | 0) / o, u = (Math.cos(s) * r.scaleY * o | 0) / o, f = this.t.style, c = this.t.currentStyle;
            if (c) {
                i = l,
                l = -h,
                h = -i,
                e = c.filter,
                f.filter = "";
                var p, d, m = this.t.offsetWidth, g = this.t.offsetHeight, v = "absolute" !== c.position, y = "progid:DXImageTransform.Microsoft.Matrix(M11=" + a + ", M12=" + l + ", M21=" + h + ", M22=" + u, x = r.x + m * r.xPercent / 100, w = r.y + g * r.yPercent / 100;
                ...
                v ? (p = m / 2,
                d = g / 2,
                y += ", Dx=" + (p - (p * a + d * l) + x) + ", Dy=" + (d - (p * h + d * u) + w) + ")") : y += ", sizingMethod='auto expand')",
                -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? f.filter = e.replace(L, y) : f.filter = y + " " + e,
                (0 === t || 1 === t) && 1 === a && 0 === l && 0 === h && 1 === u && (v && -1 === y.indexOf("Dx=0, Dy=0") || b.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && f.removeAttribute("filter")),
                !v) {
                    var P, S, O, k = 8 > _ ? 1 : -1;
                    for (p = r.ieOffsetX || 0,
                    d = r.ieOffsetY || 0,
            ...
            var e, i, r, n, s, o, a, l, h, u, f, c, d, _, m, g, v, y, x, w, T, b, P, S = this.data, O = this.t.style, k = S.rotation, C = S.rotationX, A = S.rotationY, R = S.scaleX, M = S.scaleY, F = S.scaleZ, L = S.x, z = S.y, D = S.z, X = S.svg, N = S.perspective, Y = S.force3D;
            if (((1 === t || 0 === t) && "auto" === Y && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !Y) && !D && !N && !A && !C && 1 === F || St && X || !Rt)
                return void (k || S.skewX || X ? (k *= E,
                b = S.skewX * E,
                P = 1e5,
                e = Math.cos(k) * R,
                n = Math.sin(k) * R,
                i = Math.sin(k - b) * -M,
                s = Math.cos(k - b) * M,
                b && "simple" === S.skewType && (v = Math.tan(b - S.skewY * E),
                v = Math.sqrt(1 + v * v),
                i *= v,
                s *= v,
                S.skewY && (v = Math.tan(S.skewY * E),
                v = Math.sqrt(1 + v * v),
                e *= v,
                n *= v)),
                X && (L += S.xOrigin - (S.xOrigin * e + S.yOrigin * i) + S.xOffset,
                z += S.yOrigin - (S.xOrigin * n + S.yOrigin * s) + S.yOffset,
                St && (S.xPercent || S.yPercent) && (_ = this.t.getBBox(),
                L += .01 * S.xPercent * _.width,
                z += .01 * S.yPercent * _.height),
                _ = 1e-6,
                _ > L && L > -_ && (L = 0),
                _ > z && z > -_ && (z = 0)),
                x = (e * P | 0) / P + "," + (n * P | 0) / P + "," + (i * P | 0) / P + "," + (s * P | 0) / P + "," + L + "," + z + ")",
                X && St ? this.t.setAttribute("transform", "matrix(" + x) : O[kt] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + x) : O[kt] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + R + ",0,0," + M + "," + L + "," + z + ")");
            if (p && (_ = 1e-4,
            _ > R && R > -_ && (R = F = 2e-5),
            _ > M && M > -_ && (M = F = 2e-5),
            ...
            k || S.skewX)
                ...
                m = Math.cos(k),
                g = Math.sin(k),
                "simple" === S.skewType && (v = Math.tan((S.skewX - S.skewY) * E),
                v = Math.sqrt(1 + v * v),
                m *= v,
                g *= v,
                S.skewY && (v = Math.tan(S.skewY * E),
                ...
                if (!(A || C || 1 !== F || N || X))
                    return void (O[kt] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) translate3d(" : "translate3d(") + L + "px," + z + "px," + D + "px)" + (1 !== R || 1 !== M ? " scale(" + R + "," + M + ")" : ""));
                e = s = 1,
                i = n = 0
            }
            h = 1,
            ...
            C || A || 1 !== F ? (x += w + (_ > l && l > -_ ? T : l) + w + (_ > f && f > -_ ? T : f) + w + (_ > r && r > -_ ? T : r),
            x += w + (_ > o && o > -_ ? T : o) + w + (_ > h && h > -_ ? T : h) + w + (_ > c && c > -_ ? T : c) + w) : x += ",0,0,0,0,1,0,",
        ...
        bt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
            parser: function(t, e, i, r, s, a, l) {
                ...
                l[i] = e);
                var u, f, c, p, d, _, v, y, x, w = t._gsTransform, T = t.style, b = 1e-6, P = Ot.length, S = l, O = {}, k = "transformOrigin", C = It(t, n, !0, S.parseTransform), A = S.transform && ("function" == typeof S.transform ? S.transform(g, m) : S.transform);
                if (r._transform = C,
                A && "string" == typeof A && kt)
                    ...
                    Et(t, ot(S.transformOrigin), A, S.svgOrigin, S.smoothOrigin, !0),
                    _ = A.xOrigin,
                    v = A.yOrigin,
                    ...
                    u.xPercent = lt(S.x, C.xPercent)),
                    "string" == typeof S.y && -1 !== S.y.indexOf("%") && (u.y = 0,
                    u.yPercent = lt(S.y, C.yPercent)),
                    ...
                    Rt && (u.rotationX = ht("rotationX"in S ? S.rotationX : "shortRotationX"in S ? S.shortRotationX + "_short" : C.rotationX || 0, C.rotationX, "rotationX", O),
                    ...
                    (u.skewY = ht(S.skewY, C.skewY)) && (u.skewX += u.skewY,
                    u.rotation += u.skewY)
                }
                for (Rt && null != S.force3D && (C.force3D = S.force3D,
                p = !0),
                ...
                c || null == S.scale || (u.scaleZ = 1); --P > -1; )
                    x = Ot[P],
                    A = u[x] - C[x],
                    (A > b || -b > A || null != S[x] || null != N[x]) && (p = !0,
                    s = new vt(C,x,C[x],A,s),
                    x in O && (s.e = O[x]),
                    s.xs0 = 0,
                    s.plugin = a,
                    r._overwriteProps.push(s.n));
                return A = S.transformOrigin,
                C.svg && (A || S.svgOrigin) && (_ = C.xOffset,
                v = C.yOffset,
                ...
                (_ !== C.xOffset || v !== C.yOffset) && (s = yt(C, "xOffset", w ? _ : C.xOffset, C.xOffset, s, k),
                s = yt(C, "yOffset", w ? v : C.yOffset, C.yOffset, s, k)),
                A = St ? null : "0px 0px"),
                (A || Rt && c && C.zOrigin) && (kt ? (p = !0,
                x = At,
                A = (A || $(t, x, n, !1, "50% 50%")) + "",
        ...
        bt("borderRadius", {
            ...
            parser: function(t, e, i, s, o, a) {
                e = this.format(e);
                var l, h, u, f, c, p, d, _, m, g, v, y, x, w, T, b, P = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"], S = t.style;
                ...
                h = 0; h < P.length; h++)
                    ...
                    y = c.substr((d + "").length),
                    x = "=" === p.charAt(1),
                    x ? (_ = parseInt(p.charAt(0) + "1", 10),
                    p = p.substr(2),
                    _ *= parseFloat(p),
                    v = p.substr((_ + "").length - (0 > _ ? 1 : 0)) || "") : (_ = parseFloat(p),
                    v = p.substr((_ + "").length)),
                    "" === v && (v = r[i] || y),
                    v !== y && (w = J(t, "borderLeft", d, y),
                    T = J(t, "borderTop", d, y),
                    "%" === v ? (c = w / m * 100 + "%",
                    f = T / g * 100 + "%") : "em" === v ? (b = J(t, "borderLeft", 1, "em"),
                    c = w / b + "em",
                    f = T / b + "em") : (c = w + "px",
                    f = T + "px"),
                    x && (p = parseFloat(c) + _ + v,
                    u = parseFloat(f) + _ + v)),
        ...
        bt("backgroundPosition", {
            defaultValue: "0 0",
            parser: function(t, e, i, r, s, o) {
                var a, l, h, u, f, c, p = "background-position", d = n || K(t, null), m = this.format((d ? _ ? d.getPropertyValue(p + "-x") + " " + d.getPropertyValue(p + "-y") : d.getPropertyValue(p) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) || "0 0"), g = this.format(e);
                if (-1 !== m.indexOf("%") != (-1 !== g.indexOf("%")) && g.split(",").length < 2 && (c = $(t, "backgroundImage").replace(A, ""),
                c && "none" !== c)) {
                    for (a = m.split(" "),
                    l = g.split(" "),
                    ...
                    h = 2; --h > -1; )
                        m = a[h],
                        u = -1 !== m.indexOf("%"),
                        u !== (-1 !== l[h].indexOf("%")) && (f = 0 === h ? t.offsetWidth - B.width : t.offsetHeight - B.height,
                        a[h] = u ? parseFloat(m) / 100 * f + "px" : parseFloat(m) / f * 100 + "%");
                    m = a.join(" ")
                }
        ...
        bt("clip", {
            ...
            parser: function(t, e, i, r, s, o) {
                ...
                e = this.format(e).split(",").join(h)) : (a = this.format($(t, this.p, n, !1, this.dflt)),
                e = this.format(e)),
        ...
        var qt = function(t) {
            var e, i = this.t, r = i.filter || $(this.data, "filter") || "", n = this.s + this.c * t | 0;
            100 === n && (-1 === r.indexOf("atrix(") && -1 === r.indexOf("radient(") && -1 === r.indexOf("oader(") ? (i.removeAttribute("filter"),
            e = !$(this.data, "filter")) : (i.filter = r.replace(S, ""),
            e = !0)),
        ...
        bt("opacity,alpha,autoAlpha", {
            ...
            parser: function(t, e, i, r, s, o) {
                ...
                U ? s = new vt(l,"opacity",a,e - a,s) : (s = new vt(l,"opacity",100 * a,100 * (e - a),s),
                s.xn1 = h ? 1 : 0,
                l.zoom = 1,
                s.type = 2,
                ...
                s.plugin = o,
                s.setRatio = qt),
                h && (s = new vt(l,"visibility",0,0,s,-1,null,!1,0,0 !== a ? "inherit" : "hidden",0 === e ? "hidden" : "inherit"),
                s.xs0 = "inherit",
                r._overwriteProps.push(s.n),
        ...
        bt("className", {
            parser: function(t, e, r, s, o, a, l) {
                var h, u, f, c, p, d = t.getAttribute("class") || "", _ = t.style.cssText;
                if (o = s._classNamePT = new vt(t,r,0,0,o,2),
                o.setRatio = Ut,
                o.pr = -11,
                i = !0,
                o.b = d,
        ...
        var Wt = function(t) {
            if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                var e, i, r, n, s, o = this.t.style, a = l.transform.parse;
                if ("all" === this.e)
                    o.cssText = "",
                    n = !0;
                else
                    ...
                    r = e.length; --r > -1; )
                        i = e[r],
                        l[i] && (l[i].parse === a ? n = !0 : i = "transformOrigin" === i ? At : l[i].p),
                        Vt(o, i);
                n && (Vt(o, kt),
        ...
        h._onInitTween = function(t, e, a, h) {
            ...
            var p, _, v, y, x, w, T, b, S, O = t.style;
            if (f && "" === O.zIndex && (p = $(t, "zIndex", n),
            ("auto" === p || "" === p) && this._addLazySet(O, "zIndex", 0)),
            ...
            this._transformType) {
                ...
                kt ? c && (f = !0,
                "" === O.zIndex && (T = $(t, "zIndex", n),
                ("auto" === T || "" === T) && this._addLazySet(O, "zIndex", 0)),
                d && this._addLazySet(O, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (S ? "visible" : "hidden"))) : O.zoom = 1,
                v = _; v && v._next; )
                    v = v._next;
                b = new vt(t,"transform",0,0,null,2),
                this._linkCSSP(b, null, v),
                b.setRatio = kt ? Bt : $t,
                b.data = this._transform || It(t, n, !0),
                b.tween = a,
                b.pr = -1,
                s.pop()
            }
        ...
        h.parse = function(t, e, i, s) {
            var o, a, h, f, c, p, d, _, v, y, x = t.style;
            for (o in e)
                p = e[o],
                "function" == typeof p && (p = p(g, m)),
                a = l[o],
                a ? i = a.parse(t, p, o, this, i, s, e) : (c = $(t, o, n) + "",
                v = "string" == typeof p,
                "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || v && O.test(p) ? (v || (p = ct(p),
                p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"),
                i = xt(x, o, c, p, !0, "transparent", i, 0, s)) : v && D.test(p) ? i = xt(x, o, c, p, !0, null, i, 0, s) : (h = parseFloat(c),
                d = h || 0 === h ? c.substr((h + "").length) : "",
                ("" === c || "auto" === c) && ("width" === o || "height" === o ? (h = st(t, o, n),
                d = "px") : "left" === o || "top" === o ? (h = tt(t, o, n),
                ...
                p = p.substr(2),
                f *= parseFloat(p),
                _ = p.replace(T, "")) : (f = parseFloat(p),
                _ = v ? p.replace(T, "") : ""),
                "" === _ && (_ = o in r ? r[o] : d),
                p = f || 0 === f ? (y ? f + h : f) + _ : e[o],
                d !== _ && "" !== _ && (f || 0 === f) && h && (h = J(t, o, h, d),
                "%" === _ ? (h /= J(t, o, 100, "%") / 100,
                e.strictUnits !== !0 && (c = h + "%")) : "em" === _ || "rem" === _ || "vw" === _ || "vh" === _ ? h /= J(t, o, 1, _) : "px" !== _ && (f = J(t, o, f, _),
                _ = "px"),
                y && (f || 0 === f) && (p = f + h + _)),
                y && (f += h),
                !h && 0 !== h || !f && 0 !== f ? void 0 !== x[o] && (p || p + "" != "NaN" && null != p) ? (i = new vt(x,o,f || h || 0,0,i,-1,o,!1,0,c,p),
                i.xs0 = "none" !== p || "display" !== o && -1 === o.indexOf("Style") ? p : c) : G("invalid " + o + " tween value: " + e[o]) : (i = new vt(x,o,h,f - h,i,0,o,u !== !1 && ("px" === _ || "zIndex" === o),0,c,p),
                i.xs0 = _))),
        ...
        h.setRatio = function(t) {
            ...
            if (1 !== t || this._tween._time !== this._tween._duration && 0 !== this._tween._time)
                if (t || this._tween._time !== this._tween._duration && 0 !== this._tween._time || this._tween._rawPrevTime === -1e-6)
                    for (; n; ) {
                        if (e = n.c * t + n.s,
                        n.r ? e = Math.round(e) : s > e && e > -s && (e = 0),
                        n.type)
                            if (1 === n.type)
                                if (r = n.l,
                                2 === r)
        ...
        h._enableTransforms = function(t) {
            this._transform = this._transform || It(this._target, n, !0),
        ...
        return o.cascadeTo = function(t, i, r) {
            var n, s, o, a, l = e.to(t, i, r), h = [l], u = [], f = [], c = [], p = e._internals.reservedProps;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("plugins.CSSRulePlugin", ["plugins.TweenPlugin", "TweenLite", "plugins.CSSPlugin"], function(t, e, i) {
        ...
        r.getRule = function(t) {
            var e, i, r, s, o = n.all ? "rules" : "cssRules", a = n.styleSheets, l = a.length, h = ":" === t.charAt(0);
            for (t = (h ? "" : ",") + t.toLowerCase() + ",",
            h && (s = []); --l > -1; ) {
                try {
                    if (i = a[l][o],
                    !i)
                ...
                for (; --e > -1; )
                    if (r = i[e],
                    r.selectorText && -1 !== ("," + r.selectorText.split("::").join(":").toLowerCase() + ",").indexOf(t)) {
                        if (!h)
                            return r.style;
                        s.push(r.style)
                    }
        ...
        o._onInitTween = function(t, e, r) {
            ...
            i.prototype._onInitTween.call(this, s, e, r),
            !0
        }
        ,
    ...
    var t = document.documentElement
      ...
      , a = _gsScope._gsDefine.plugin({
        ...
        set: function(t) {
            ...
            this.x < 0 && (this.x = 0),
            this.y < 0 && (this.y = 0),
            this._autoKill && (!this.skipX && (o > l || -l > o) && r < i(this._target, "x") && (this.skipX = !0),
            !this.skipY && (s > l || -l > s) && n < i(this._target, "y") && (this.skipY = !0),
            this.skipX && this.skipY && (this._tween.kill(),
            this.vars.onAutoKill && this.vars.onAutoKill.apply(this.vars.onAutoKillScope || this._tween, this.vars.onAutoKillParams || []))),
            this._wdw ? e.scrollTo(this.skipX ? r : this.x, this.skipY ? n : this.y) : (this.skipY || (this._target.scrollTop = this.y),
...
!function(t) {
    "use strict";
    var e, i, r, n = t.fn.animate, s = t.fn.stop, o = !0, a = function(t) {
        var e, i = {};
        for (e in t)
            i[e] = t[e];
        return i
        ...
        repeatDelay: 1,
        autoCSS: 1
    }, h = ",scrollTop,scrollLeft,show,hide,toggle,", u = h, f = function(t, e) {
        for (var i in l)
        ...
        var n, s, o, a = window.GreenSockGlobals || window;
        if (e = a.TweenMax || a.TweenLite,
        e && (n = (e.version + ".0.0").split("."),
        ...
        !e || !i || s)
            return e = null,
            void (!r && window.console && (window.console.log("The jquery.gsap.js plugin requires the TweenMax (or at least TweenLite and CSSPlugin) JavaScript file(s)." + (s ? " Version " + n.join(".") + " is too old." : "")),
            r = !0));
        if (t.easing) {
            for (o in p)
                t.easing[o] = c(p[o]);
    ...
    t.fn.animate = function(r, s, l, h) {
        ...
        if (!o || r.skipGSAP === !0 || "object" == typeof s && "function" == typeof s.step)
            return n.call(this, r, s, l, h);
        var c, _, m, g, v = t.speed(s, l, h), y = {
            ease: p[v.easing] || (v.easing === !1 ? p.linear : p.swing)
        }, x = this, w = "object" == typeof s ? s.specialEasing : null;
        for (_ in r) {
            if (c = r[_],
            c instanceof Array && p[c[1]] && (w = w || {},
            w[_] = c[1],
            c = c[0]),
            "show" === c || "hide" === c || "toggle" === c || -1 !== u.indexOf(_) && -1 !== u.indexOf("," + _ + ","))
                return n.call(this, r, s, l, h);
        ...
        ,
        v.queue !== !1 ? (x.queue(v.queue, m),
        "function" == typeof v.old && t(x[x.length - 1]).queue(v.queue, function(t) {
            v.old.call(x),
            t()
        })) : m.call(x),
        x
...
!function(t, e) {
    ...
    t.Controller = function(r) {
        var s, o, a = "ScrollMagic.Controller", l = "FORWARD", h = "REVERSE", u = "PAUSED", f = i.defaults, c = this, p = n.extend({}, f, r), d = [], _ = !1, m = 0, g = u, v = !0, y = 0, x = !0, w = function() {
            for (var t in p)
                f.hasOwnProperty(t) || delete p[t];
        ...
        this.updateScene = function(e, i) {
            return n.type.Array(e) ? e.forEach(function(t) {
                c.updateScene(t, i)
            }) : i ? e.update(!0) : _ !== !0 && e instanceof t.Scene && (_ = _ || [],
        ...
        this.scrollPos = function(t) {
            return arguments.length ? (n.type.Function(t) && (b = t),
            c) : b.call(c)
        }
        ,
    ...
    ,
    t.Scene = function(i) {
        var s, o, a = "BEFORE", l = "DURING", h = "AFTER", u = r.defaults, f = this, c = n.extend({}, u, i), p = a, d = 0, _ = {
            start: 0,
            end: 0
        }, m = 0, g = !0, v = function() {
            for (var t in c)
                u.hasOwnProperty(t) || delete c[t];
            for (var e in u)
                k(e);
            S()
        }, y = {};
        ...
        this.addTo = function(e) {
            return e instanceof t.Controller && o != e && (o && o.removeScene(f),
            o = e,
            S(),
            w(!0),
            T(!0),
            ...
            if (o)
                if (t)
                    if (o.enabled() && g) {
                        ...
                        e = c.duration > 0 ? (i - _.start) / (_.end - _.start) : i >= _.start ? 1 : 0,
                        f.trigger("update", {
                            startPos: _.start,
                            endPos: _.end,
                            scrollPos: i
        ...
        this.progress = function(t) {
            if (arguments.length) {
                var e = !1
                  ...
                  , n = c.reverse || t >= d;
                if (0 === c.duration ? (e = d != t,
                d = 1 > t && n ? 0 : 1,
                p = 0 === d ? a : l) : 0 > t && p !== a && n ? (d = 0,
                p = a,
                e = !0) : t >= 0 && 1 > t && n ? (d = t,
                p = l,
                e = !0) : t >= 1 && p !== h ? (d = 1,
        ...
        var x = function() {
            ...
            o && c.triggerElement && (_.start -= o.info("size") * c.triggerHook),
            _.end = _.start + c.duration
        }
          , w = function(t) {
            if (s) {
                var e = "duration";
                O(e, s.call(f)) && !t && (f.trigger("change", {
                    what: e,
                    newval: c[e]
                }),
                f.trigger("shift", {
          ...
          , T = function(t) {
            var i = 0
              , r = c.triggerElement;
            if (o && r) {
                for (var s = o.info(), a = n.get.offset(s.container), l = s.vertical ? "top" : "left"; r.parentNode.hasAttribute(e); )
                    r = r.parentNode;
          ...
          , b = function() {
            c.triggerHook > 0 && f.trigger("shift", {
        ...
        this.triggerPosition = function() {
            var t = c.offset;
            return o && (t += c.triggerElement ? m : o.info("size") * f.triggerHook()),
            t
        }
        ;
        var C, A;
        ...
        var R = function(t) {
            if (C && o) {
                ...
                if (t || p !== l) {
                    ...
                    A.pushFollowers ? c.duration > 0 && (p === h && 0 === parseFloat(n.css(A.spacer, "padding-top")) ? s = !0 : p === a && 0 === parseFloat(n.css(A.spacer, "padding-bottom")) && (s = !0)) : r[e.vertical ? "top" : "left"] = c.duration * d,
                    n.css(i, r),
                    s && M()
                } else {
          ...
          , M = function() {
            if (C && o && A.inFlow) {
                var t = p === l
                  ...
                  , s = {};
                A.relSize.width || A.relSize.autoFullWidth ? t ? n.css(C, {
                    width: n.get.width(A.spacer)
                }) : n.css(C, {
                    width: "100%"
                }) : (s["min-width"] = n.get.width(e ? C : i, !0, !0),
                s.width = t ? s["min-width"] : "auto"),
                A.relSize.height ? t ? n.css(C, {
                    height: n.get.height(A.spacer) - (A.pushFollowers ? c.duration : 0)
                }) : n.css(C, {
                    height: "100%"
                }) : (s["min-height"] = n.get.height(e ? i : C, !0, !r),
                s.height = t ? s["min-height"] : "auto"),
                A.pushFollowers && (s["padding" + (e ? "Top" : "Left")] = c.duration * d,
                s["padding" + (e ? "Bottom" : "Right")] = c.duration * (1 - d)),
                n.css(A.spacer, s)
            }
        }
          , F = function() {
          ...
          , L = function() {
            o && C && p === l && ((A.relSize.width || A.relSize.autoFullWidth) && n.get.width(window) != n.get.width(A.spacer.parentNode) || A.relSize.height && n.get.height(window) != n.get.height(A.spacer.parentNode)) && M()
        }
          , z = function(t) {
            o && C && p === l && !o.info("isDocument") && (t.preventDefault(),
        ...
        this.setPin = function(t, i) {
            ...
            if (a || n.extend(c, n.css(C, ["width", "height"])),
            n.css(u, c),
            u.setAttribute(e, ""),
            ...
            return A.relSize.width && n.css(u, {
                width: h.width
            }),
            A.relSize.height && n.css(u, {
                height: h.height
            }),
            u.appendChild(C),
            n.css(C, {
            ...
            (A.relSize.width || A.relSize.autoFullWidth) && n.css(C, {
        ...
        this.removePin = function(t) {
            if (C) {
                ...
                t || !o) {
                    ...
                    C.parentNode.hasAttribute(e) || (n.css(C, C.___origStyle),
        ...
        this.setClassToggle = function(t, e) {
            ...
            return 0 !== i.length && n.type.String(e) ? (E.length > 0 && f.removeClassToggle(),
            D = e,
            E = i,
    ...
    var n = t._util = function(t) {
        ...
        return c.elements = function(e) {
            ...
            if ("nodelist" === f(e) || f.Array(e))
                ...
                (f.DomElement(e) || e === document || e === t) && (i = [e]);
            return i
        }
        ,
...
$(document).ready(function() {
    ...
    $(window).width() > 991) {
        ...
        $(window).resize(function() {
            $(window).width() <= 991 ? $(".about__visual").css({
...
function myFunction() {
    alert("Dear friendsIn the face of challenges, remember your strength. Embrace your unique talents, for they are the keys to unlocking your full potential. Dreams are not just wishes; they are the roadmap to your future. Be a source of encouragement for others, and together, we can create a world filled with resilience and kindness. Today, believe in yourself and the incredible journey that lies ahead");
}
